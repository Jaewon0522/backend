		...
		<div class="l-container">
			<section class="p-komi-training">
				...
				<div class="c-character">
					<div class="c-rank-bubble">
						현재 순위 <strong class="js-rank"></strong>
					</div>
					<img id="komiCharacter" src="" class="c-character__img"
						alt="꼬미 캐릭터">
				</div>
				<!-- 성장 카드 -->
				<div class="c-growth-card">
					<div class="c-growth-card__header">
					...
					<!-- 레벨 -->
					<div class="c-level">
						<span class="c-badge c-badge--level js-level"></span> <span
							class="c-level__text"> 흡수된 도력 : <strong class="js-absorb"></strong>P
							| 남은 도력 <strong class="js-remain"></strong>P
						</span>
					</div>
					<!-- 게이지 -->
					<div class="c-progress">
						<div class="c-progress__bar">
							<div class="c-progress__value js-progress"></div>
						</div>
					</div>
					<!-- 액션 -->
